...
//                        return !s.drop(while: { $0 == "a" }).contains("a")
//                    }
//                }
//
//class Solution {
...
//    func mostWordsFound(_ sentences: [String]) -> Int {
//        var ceil = 0
//        sentences.forEach { ceil = max(ceil, $0.components(separatedBy: " ").count)}
//        return ceil
//    }
//}
...
//class Solution {
//func firstPalindrome(_ words: [String]) -> String {
//    return (words.filter { $0 == String($0.reversed()) }.first) == nil ?  "" : words.filter { $0 == String($0.reversed()) }.first!
//}
//}
//
...
//        let red = 4, green = 2, blue = 1
//        let rings = Array(rings)
//
//        var m = Array(repeating: 0, count: 10)
//
//        for i in stride(from: 0, to: rings.count-1, by: 2) {
//            let color = rings[i] == "R" ? red : rings[i] == "G" ? green : blue
//            let rod = Int(String(rings[i+1]))!
//            m[rod] |= color
//        }
//
//        return m.reduce(0) { $0 + ($1 == 7 ? 1 : 0) }
//    }
//}
//class Solution {
//    func countPoints(_ rings: String) -> Int {
//        var rods = [String: Set<String>]()
//
//        for i in stride(from: 0, to: rings.count, by: 2) {
//            let ringIndex = rings.index(rings.startIndex, offsetBy: i)
//            let ring = String(rings[ringIndex])
//            let rodIndex = rings.index(rings.startIndex, offsetBy: i + 1)
//            let rod = String(rings[rodIndex])
//
//            if var set = rods[rod] {
//                set.insert(ring)
//                rods[rod] = set
...
//        }
//
//        let rodsWithAll = rods.reduce(0, { initial, nextPartial in
//            let ringCount = nextPartial.value.count
//            return ringCount == 3 ? initial + 1 : initial
//        })
//
//        return rodsWithAll
//    }
...
//        var m1 = words1.reduce(into: [String: Int]()) { $0[$1, default: 0] += 1 }
//
//        for word in words2 where m1[word] != nil && m1[word, default: 0] < 2 {
//            m1[word, default: 0] -= 1
//        }
//
//        return m1.reduce(0) { $0 + ($1.value == 0 ? 1 : 0) }
//    }
//}
...
//                                                                            var freq = word1.reduce(into: [Character: Int]()) {
//                                                                                $0[$1, default: 0] += 1
//                                                                            }
//
//                                                                            word2.forEach {
...
//                                                                            }
//
//                                                                            return !freq.contains { (_, value) in
//                                                                                abs(value) > 3
//                                                                            }
//                                                                        }
//                                                                    }
...
//    let counts = arr.reduce(into: [String:Int]()) { $0[$1, default: 0] += 1 }
//    let distinct = arr.filter { counts[$0] == 1 }
...
//                                    let punctuation = ".,!"
//
//                                    for word in sentence.split(separator: " ") where word == word.lowercased() {
//                                        var valid = true
